...
function getmovie() {
    ...
    <div class="profile-info">
        <h2 style="color:white;text-align:center;margin-bottom:-1rem;">${user.inName}</h2>  
        <h1 style="margin-top:10px;margin-bottom:-15px;">>>>${user.reg}
        <<<</h1>
    </div>
        ...
        <h1 >- ${user.Status} -</h1>
        <h1 style="margin:-5px;color:red;font-size:12px;">- VALIDITY:${user.validity} -</h1></div>
        </div>
        <div style="margin-top:-15px;"class="profile-bottom">
             <div style="display:flex;margin-left:-.4rem;">
                <div style="width:25%;margin:0 2px;">
                ...
                <div style="width:45%;margin:0 2px;">
                    <h1 style="font-size:12px;margin-top:-5px;text-align:center;padding:0 1rem;">YEAR OF ADMIN</h1>
                    <div class="profile-info">
                    <h1 style="color:black;padding:0 .8rem;">${user.yearofadmin}</h1>
                    </div>
                </div>
                <div style="width:25%;margin:0 2px;">
                    ...
                    <h1 style="font-size:12px;margin-top:-5px;text-align:center;">CONTACT:</h1>
                        <div class="profile-info">
                            <a style="text-decoration: none;" href="Tel:${user.inparentno}"><div class="p1">
                                    <p2 style="margin-left:-5px;">${user.inparentno}</p2>
                            </div></a>                   
                        </div>
                </div>
                <div>
                <h1 style="font-size:12px;margin-top:-5px;text-align:center;">NEXT OF KIN:</h1>
                    <div class="profile-info">
                        <a style="text-decoration: none;" href="Tel:${user.inparentno2}"><div class="p2">
                                <p2 style="margin-left:-5px;">${user.inparentno2}</p2>
                        </div></a>                   
                    </div>
            </div>
