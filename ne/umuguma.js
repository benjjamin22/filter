...
function getmovie() {
    ...
    console.log(movieId)
    fetch('http://benjjamin22.github.io/gitadd/mydata.json/' + movieId)
        .then(response => response.json())
        .then(data => {
            const li = document.createElement('li')
            li.innerHTML = `<div style="display:flex">
            <a Style="margin: 0%; font-size: 12px; padding: 0px 5rem; text-align: center; width:0px; height: 20px; background-color: transparent; color: black; text-decoration: none; border-radius: 3px; border: 1px rgb(214, 211, 211) solid;"
            href="evette sch. of cat.html">back</a>
            <a Style="margin: 0%; font-size: 12px; padding: 0px 5rem; text-align: center; width:0px; height: 20px; background-color: transparent; color: black; text-decoration: none; border-radius: 3px; border: 1px rgb(214, 211, 211) solid;"
            ...
            <div class="user-profile">
                ...
                <div class="profile-bottom">
                    ...
                    <div class="profile-info">
                        <a style="text-decoration: none;" href="Tel:${data.inparentno}"><div class="p1">
                                <p2>${data.inparentno}</p2>
                        </div></a>
                        <a style="text-decoration: none;" href="Tel:${data.inparentno2}"><div class="p2">
                            <p2>${data.inparentno2}</p2>
                        </div></a>
                    </div>
